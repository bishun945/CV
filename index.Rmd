...
This [**resume**](https://github.com/bishun945/CV) was made with the R package [**pagedown**](https://github.com/rstudio/pagedown).
...
Thesis: Remote Sensing of Column-integrated Algal Biomass for Inland Waters Based on Soft Classification <br> (Qualified for the Successive Master-Doctor Program in 2018 and expected to receive the degree in June 2021)
...
IEEE Transactions on Geoscience and Remote Sensing, *press*, **IF  5.855**
